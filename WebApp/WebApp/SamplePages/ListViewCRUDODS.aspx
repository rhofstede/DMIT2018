...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" DataKeyNames="AlbumID" InsertItemPosition="LastItem">
        ...
        <EditItemTemplate>
            ...
            <asp:RegularExpressionValidator ID="RegExTitleTextBoxE" runat="server" ErrorMessage="Title is limited to 160 characters." ControlToValidate="TitleTextBoxE" ValidationExpression="^.{1, 160}$" ValidationGroup="EGroup"></asp:RegularExpressionValidator>
            ...
            <asp:RegularExpressionValidator ID="RegExReleaseYearTextBoxE" runat="server" ErrorMessage="Release label is limited to 50 characters." ControlToValidate="ReleaseLabelTextBoxE" ValidationExpression="^.{0, 50}$" ValidationGroup="EGroup"></asp:RegularExpressionValidator>
        ...
        <InsertItemTemplate>
            ...
            <asp:RegularExpressionValidator ID="RegExTitleTextBoxI" runat="server" ErrorMessage="Title is limited to 160 characters." ControlToValidate="TitleTextBoxI" ValidationExpression="^.{1, 160}$" ValidationGroup="IGroup"></asp:RegularExpressionValidator>
            ...
            <asp:RegularExpressionValidator ID="RegExReleaseLabelTextBoxI" runat="server" ErrorMessage="Release label is limited to 50 characters." ControlToValidate="ReleaseLabelTextBoxI" ValidationExpression="^.{0, 50}$" ValidationGroup="IGroup"></asp:RegularExpressionValidator>
    ...
    <asp:ObjectDataSource ID="ArtistListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Artist_List" TypeName="ChinookSystem.BLL.ArtistController" OnSelected="CheckForException">
    </asp:ObjectDataSource>
</asp:Content>
